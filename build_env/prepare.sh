...
# export DIST_ROOT=/home/hamonikr/Download/LLD_linux_dist
...
mkdir -pv $LFS/{etc,var,tools} $LFS/usr/{bin,lib,lib64,sbin}
...
passwd distbuild
chown -v distbuild $LFS/{usr{,/*},var,etc,tools,sources}
